(
WhoTime.muf v1.3M2, by Stelard Actek of StelTechCor @ FurryMUCK!
...
$include $lib/look
$include $lib/strings
$def HEADER "-Name--------------Sex-----Species---------------------Local-Time---------------"
$def FOOTER "--------------------------------------------------------------------------------"
...
" " .tell
"Please also note that this version has had the idle status code removed to run" .tell
"within M2 limitations." .tell
;
